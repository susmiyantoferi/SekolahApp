...
<head>
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Login Page</span>
                </a>
              </div>
            </div>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; Zero Copyright Susmiyanto Dev Studio Template By
          <a class="text-primary" href="http://irefmcr@gmail.com/" target="_blank">Susmiyanto</a>.
        </p>
      </div>
    </div>
</body>
